...
class BaseUrl{
    ...
    static AllRecoveryLastDataShow = this.BaseURL+'/recoverylastall';
    ...
    static AllFacilitiesDataShow = this.BaseURL+'/facilitiesall';
    ...
    static AllCorporateWellnessDataShow = this.BaseURL+'/corwellall';
}
